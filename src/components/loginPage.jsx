      ...
      <div className="relative z-10 w-full max-w-[420px] p-8 sm:p-10 bg-[#0A0A0A] border border-[#222] rounded-xl shadow-2xl mx-4">
          ...
          {ROLES.map(r => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-2.5 px-2 flex flex-col items-center gap-1.5 text-sm font-medium rounded-lg border transition-all duration-500 ease-in-out ${
                  isActive 
        ...
        <div className="mt-6 text-center border-t border-[#222] pt-4">
          <p className="text-sm text-gray-500">
            Need help? <a href="mailto:admin@gmail.com" className="text-gray-400 hover:text-white transition-colors">Email: admin@gmail.com</a>
          </p>
        </div>
